...
import { PlusOutlined, CloseOutlined } from '@ant-design/icons'; // Import icons separately
...
class NewPoll extends Component {
    constructor(props) {
        ...
        this.state = {
            question: {
                text: '',
                validateStatus: '', // Added for validation status
                errorMsg: '' // Added for error message
            },
            choices: [{
                text: '',
                validateStatus: '', // Added for validation status
